...
<div class="w3-row-padding w3-padding-16 w3-center w3-margin">
	<form method="POST" action="GerichtHinzufuegen.php">
      ...
      <input type="text" name="bezeichnung" value=""><br>
      Produkt-Beschreibung:<br>
      <input type="text" name="beschreibung" value=""><br>
      Produkt-Preis:<br>
      <input type="text" name="preis" value=""><br>
      Katgorie:<br>
      ...
      Bildadresse:<br>
      <input type="text" name="bild" value="..\img\xyz.jpg"><br><br>
      
      <input type="submit" name="newitem" value="Hinzuf&uuml;gen" class="w3-button w3-blue">
    </form>
...
<footer class="container-fluid md-12 text center navbar-fixed-bottom w3-margin-top">
