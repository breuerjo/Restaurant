...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a href="Startseite.php"><img alt="Logo" src="..\img\Logo.jpg" width="70px" height="48px"></a>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a href="Startseite.php"><img alt="Logo" src="..\img\Logo.jpg" width="75px" height="54px"></a>      
      <a id="restaurant-name" class="navbar-brand" href="Startseite.php"><b><?php echo getRestaurantName(); ?></b></a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
