...
<br>
	...
	<div id="Impressum-Text" class="container-fluid text-center">
		...
		<p>
			...
			089/1234567-9<br> E-Mail: <br>
			<br>
		<?php printImage();?>
		<br>
			<br> Website: www.mustermann.de<br> <br> Bei redaktionellen Inhalten:<br>
			<br> Verantwortlich nach § 55 Abs.2 RStV<br> Moritz Schreiberling<br>
			Musterstraße 2<br> 80999 München
		</p>
