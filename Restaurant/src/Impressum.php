...
?>
	...
	<div id="Impressum-Text" class="container-fluid text-center">
		...
		<br>
		<p>
			Anbieter:<br> Max Mustermann<br> MusterstraÃŸe 1<br> 80999 MÃ¼nchen<br>
		...
		<br> <br> Website: www.mustermann.de<br> <br> Bei redaktionellen
			Inhalten:<br> <br> Verantwortlich nach Â§ 55 Abs.2 RStV<br> Moritz
			Schreiberling<br> MusterstraÃŸe 2<br> 80999 MÃ¼nchen
		</p>

	</div>
	<br>
	
		<div id="Datenschutz-Text" class="container-fluid text-center">
		<br>
		<h1 id="Datenschutz">
			<b>Datenschutz</b>
		</h1>
